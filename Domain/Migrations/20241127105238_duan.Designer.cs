            ...
            modelBuilder.Entity("AppData.Model.ChatLieu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdChatLieu = new Guid("e97d4b06-f476-467e-a36b-2e72250488e4"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2469),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2477),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                        ...
                        new
                        {
                            IdChatLieu = new Guid("fd35314a-4b3b-4e3f-a25f-a95bbc89f11e"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2487),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2487),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenChatLieu = "Da thật"
                        },
                        new
                        {
                            IdChatLieu = new Guid("da86efab-4c4a-467d-a290-e19ccc2e7fbc"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2489),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(2490),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
            ...
            modelBuilder.Entity("AppData.Model.ChucVu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdChucVu = new Guid("f6216b98-9ee4-4bd5-b5e3-65ea3564cb57"),
                            Code = "QL",
                            TenChucVu = "Quản lý"
                        },
                        new
                        {
                            IdChucVu = new Guid("cede7b05-5211-4c5d-bd95-cc89c3e5096f"),
                            Code = "NV",
                            TenChucVu = "Nhân viên"
                        },
                        new
                        {
                            IdChucVu = new Guid("523ff56a-f57b-4bf4-a4f4-afb8d0e7f9a8"),
                            Code = "KT",
                            TenChucVu = "Kế toán"
                        },
                        new
                        {
                            IdChucVu = new Guid("891e47bb-0810-4da6-9d96-b2eab12cb5ac"),
                            Code = "KK",
                            TenChucVu = "Thủ kho"
                        });
                });
            ...
            modelBuilder.Entity("AppData.Model.DanhMuc", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdDanhMuc = new Guid("ff56f3d6-9a06-4ef0-9ad1-36849e39cabd"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7903),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7898),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                        ...
                        new
                        {
                            IdDanhMuc = new Guid("023fc039-dd8b-4392-8c11-f7e1035ac8c8"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7906),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7905),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenDanhMuc = "Giày Da"
                        },
                        new
                        {
                            IdDanhMuc = new Guid("887d857a-da4a-449f-9d1a-6f004b88a137"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7912),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 38, DateTimeKind.Local).AddTicks(7912),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
            ...
            modelBuilder.Entity("AppData.Model.DeGiay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdDeGiay = new Guid("0e8e2a94-ce99-4cbf-9901-e7cca416ea51"),
                            KichHoat = 1,
                        ...
                        new
                        {
                            IdDeGiay = new Guid("c356efe3-d6c8-4729-8d02-f65194ffe826"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NguoiCapNhat = "Admin",
                        ...
                        new
                        {
                            IdDeGiay = new Guid("02fdf998-f6ee-4fbb-8765-fc8d958e43f5"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NguoiCapNhat = "Admin",
            ...
            modelBuilder.Entity("AppData.Model.KichCo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdKichCo = new Guid("3a83c870-42ca-466f-a458-55d77e765b4f"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7931),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7936),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenKichCo = "Size 37"
                        },
                        new
                        {
                            IdKichCo = new Guid("43a0136b-5e7a-4c97-a555-5cf69e2dc1ef"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7938),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7939),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenKichCo = "Size 38"
                        },
                        new
                        {
                            IdKichCo = new Guid("10a7c6a0-3f81-433a-81a3-cfe89b8c84b9"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7940),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 42, DateTimeKind.Local).AddTicks(7941),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenKichCo = "Size 39"
                        });
            ...
            modelBuilder.Entity("AppData.Model.KieuDang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdKieuDang = new Guid("a34eb216-fc20-41d2-b732-35af547b03e1"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1073),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1071),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                        ...
                        new
                        {
                            IdKieuDang = new Guid("be1a2b82-5aa3-4694-8ea1-aceead9b05bb"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1087),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1087),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenKieuDang = "Cổ Điển"
                        },
                        new
                        {
                            IdKieuDang = new Guid("86d332b5-f4a0-4c4d-8680-bb9720e7152d"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1089),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 43, DateTimeKind.Local).AddTicks(1089),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
            ...
            modelBuilder.Entity("AppData.Model.MauSac", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdMauSac = new Guid("d3e2c1b7-b57c-465a-9fef-fbed5149dbdd"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4895),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4898),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenMauSac = "Red"
                        },
                        new
                        {
                            IdMauSac = new Guid("04559b88-6453-45ae-a4dc-b7483b6fb17d"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4901),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4901),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenMauSac = "Green"
                        },
                        new
                        {
                            IdMauSac = new Guid("bc546fcc-7122-43c2-8995-c38c82c721f0"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4903),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 44, DateTimeKind.Local).AddTicks(4903),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenMauSac = "Blue"
                        });
            ...
            modelBuilder.Entity("AppData.Model.ThuongHieu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdThuongHieu = new Guid("a275c324-25b1-4488-932c-b220111653a1"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6794),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6791),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenThuongHieu = "Nike"
                        },
                        new
                        {
                            IdThuongHieu = new Guid("ff5e57eb-dbd4-422c-b6bc-ba464b5733ef"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6798),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6798),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                        ...
                        new
                        {
                            IdThuongHieu = new Guid("f3490e7e-df4d-414b-bb98-9dc158d12e1c"),
                            KichHoat = 1,
                            NgayCapNhat = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6800),
                            NgayTao = new DateTime(2024, 11, 27, 17, 52, 38, 48, DateTimeKind.Local).AddTicks(6800),
                            NguoiCapNhat = "Admin",
                            NguoiTao = "Admin",
                            TenThuongHieu = "Puma"
                        });
